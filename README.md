...
RESOLUTION
  ...
  coverage                    16.8%   resolved at all
  ambiguity rate              82.4%   correctly refused
  contradiction rate           0.8%
...
MONEY
  processed               ₹10,204,412
  auto-posted                 ₹99,571
  protected               ₹10,104,841   refused, deliberately
  wrongly auto-posted          ₹1,786

NORTH STAR
  safe resolution rate         7.4%   resolved without a human
```

Every figure above is read from [`benchmark/results.json`](benchmark/results.json),
